...
const currency = () => {
  ...
  async function stackDataForCoins() {
    let bitcoin = await fetch('https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=usd&include_market_cap=true&include_24hr_change=true').then(res => res.json()).then(data => JSON.parse(JSON.stringify(data))).then(res => {
      renderCoinHTML('bitcoin', res.bitcoin.usd, res.bitcoin.usd_market_cap, res.bitcoin.usd_24h_change, 'btc');
    });
    let ethereum = await fetch('https://api.coingecko.com/api/v3/simple/price?ids=ethereum&vs_currencies=usd&include_market_cap=true&include_24hr_change=true').then(res => res.json()).then(data => JSON.parse(JSON.stringify(data))).then(res => {
      renderCoinHTML('ethereum', res.ethereum.usd, res.ethereum.usd_market_cap, res.ethereum.usd_24h_change, 'eth');
    });
    let tether = await fetch('https://api.coingecko.com/api/v3/simple/price?ids=tether&vs_currencies=usd&include_market_cap=true&include_24hr_change=true').then(res => res.json()).then(data => JSON.parse(JSON.stringify(data))).then(res => {
      renderCoinHTML('tether', res.tether.usd, res.tether.usd_market_cap, res.tether.usd_24h_change, 'tth');
    });
    let enjin = await fetch('https://api.coingecko.com/api/v3/simple/price?ids=enjincoin&vs_currencies=usd&include_market_cap=true&include_24hr_change=true').then(res => res.json()).then(data => JSON.parse(JSON.stringify(data))).then(res => {
...
const news = () => {
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.news__blocks__row', {
    // Navigation arrows
    slidesPerView: 1,
    spaceBetween: 30,
    loop: true,
...
/* harmony import */ var _modules_currency__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/currency */ "./src/js/modules/currency.js");
/* harmony import */ var _modules_news__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/news */ "./src/js/modules/news.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_currency__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_news__WEBPACK_IMPORTED_MODULE_2__["default"])();
